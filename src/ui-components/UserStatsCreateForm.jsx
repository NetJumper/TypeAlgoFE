...
export default function UserStatsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBestTime(initialValues.bestTime);
    setBestWPM(initialValues.bestWPM);
    setBestAccuracy(initialValues.bestAccuracy);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserStats.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserStatsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
